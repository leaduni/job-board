...
<template>
  <a
    ...
    class="group flex flex-col h-full bg-[#1A0B2E]/90 backdrop-blur-lg rounded-2xl overflow-hidden border border-[#a6249d]/30 hover:border-[#a6249d]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#a6249d]/20 hover:-translate-y-1 shadow-lg"
  >
    <!-- Image Container -->
    ...
    <div class="flex flex-col flex-grow p-5">
      ...
      <div class="flex items-center gap-2 mb-2">
        <span class="text-[11px] font-bold text-[#d93340] uppercase tracking-widest bg-[#a6249d]/10 px-2 py-0.5 rounded">
          {{ course.proveedor }}
        </span>
      </div>

      <!-- Title -->
      <h3 class="text-lg font-bold text-white leading-tight mb-3 line-clamp-2 group-hover:text-[#ff6ec7] transition-colors">
        {{ course.titulo }}
      </h3>
