<template>
  <aside class="flex flex-col gap-[18px] text-white/[0.95] sticky top-[80px]">
    ...
    >
      ...
      <button
        class="w-full py-[10px] px-[12px] rounded-[10px] bg-gradient-to-r from-[#d93340] to-[#a6249d] text-white font-bold cursor-pointer shadow-[0_6px_18px_rgba(182,38,103,0.18)] hover:-translate-y-[1px] hover:shadow-[0_10px_24px_rgba(182,38,103,0.2)] mb-[14px]"
